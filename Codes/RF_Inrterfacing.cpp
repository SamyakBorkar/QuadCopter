#include <Arduino.h>
#include <Servo.h>  // Servo library to control the ESC
...
// Pin assignments
int receiverPin1 = 3;  // Pin connected to the receiver's throttle channel for Motor 1 (CH1)
int receiverPin2 = 5;  // Pin connected to the receiver's throttle channel for Motor 2 (CH2)
int receiverPin3 = 6;  // Pin connected to the receiver's throttle channel for Motor 3 (CH3)
int receiverPin4 = 7;  // Pin connected to the receiver's throttle channel for Motor 4 (CH4)

int escPin1 = 9;  // Pin connected to the ESC signal for Motor 1
int escPin2 = 10; // Pin connected to the ESC signal for Motor 2
int escPin3 = 11; // Pin connected to the ESC signal for Motor 3
int escPin4 = 12; // Pin connected to the ESC signal for Motor 4
